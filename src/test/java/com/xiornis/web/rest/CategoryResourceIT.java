...
import com.xiornis.domain.Category;
import com.xiornis.repository.CategoryRepository;
...
class CategoryResourceIT {
    ...
    public static Category createEntity(EntityManager em) {
        Category category = new Category().name(DEFAULT_NAME).isActive(DEFAULT_IS_ACTIVE);
        return category;
    }
    ...
    public static Category createUpdatedEntity(EntityManager em) {
        Category category = new Category().name(UPDATED_NAME).isActive(UPDATED_IS_ACTIVE);
        return category;
    }
    ...
    void putNewCategory() throws Exception {
        ...
        updatedCategory.name(UPDATED_NAME).isActive(UPDATED_IS_ACTIVE);
    ...
    void fullUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.name(UPDATED_NAME).isActive(UPDATED_IS_ACTIVE);
