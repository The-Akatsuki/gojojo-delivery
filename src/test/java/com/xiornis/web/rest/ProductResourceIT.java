...
import com.xiornis.domain.Product;
import com.xiornis.repository.ProductRepository;
...
class ProductResourceIT {
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getTaxRate()).isEqualTo(DEFAULT_TAX_RATE);
    ...
    void putNewProduct() throws Exception {
        ...
        assertThat(testProduct.getTaxRate()).isEqualTo(UPDATED_TAX_RATE);
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.quantity(UPDATED_QUANTITY).taxRate(UPDATED_TAX_RATE).hsn(UPDATED_HSN);
