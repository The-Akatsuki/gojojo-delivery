...
import { ShipmentActivityComponent } from './shipment-activity.component';

describe('Component Tests', () => {
  describe('ShipmentActivity Management Component', () => {
    let comp: ShipmentActivityComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ShipmentActivityComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.shipmentActivities?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
