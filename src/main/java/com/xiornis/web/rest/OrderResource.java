...
/**
 * REST controller for managing {@link com.xiornis.domain.Order}.
 */
@RestController
@RequestMapping("/api")
@Transactional
            ...
            .map(
                existingOrder -> {
                    ...
                    if (order.getChannel() != null) {
                        existingOrder.setChannel(order.getChannel());
                    }
                    if (order.getSubtotal() != null) {
                        existingOrder.setSubtotal(order.getSubtotal());
                    }
                    if (order.getHasShippingCharges() != null) {
                        existingOrder.setHasShippingCharges(order.getHasShippingCharges());
                    }
                    if (order.getShipping() != null) {
                        existingOrder.setShipping(order.getShipping());
                    }
                    if (order.getHasGiftwrapCharges() != null) {
                        existingOrder.setHasGiftwrapCharges(order.getHasGiftwrapCharges());
                    }
                    if (order.getGiftwrap() != null) {
                        existingOrder.setGiftwrap(order.getGiftwrap());
                    }
                    if (order.getHasTransactionCharges() != null) {
                        existingOrder.setHasTransactionCharges(order.getHasTransactionCharges());
                    }
                    if (order.getTransaction() != null) {
                        existingOrder.setTransaction(order.getTransaction());
                    }
                    if (order.getHasDiscount() != null) {
                        existingOrder.setHasDiscount(order.getHasDiscount());
                    }
                    if (order.getDiscount() != null) {
                        existingOrder.setDiscount(order.getDiscount());
                    }
                    if (order.getWeight() != null) {
                        existingOrder.setWeight(order.getWeight());
                    }
                    if (order.getWeightCharges() != null) {
                        existingOrder.setWeightCharges(order.getWeightCharges());
                    }
                    if (order.getExcessWeightCharges() != null) {
                        existingOrder.setExcessWeightCharges(order.getExcessWeightCharges());
                    }
                    if (order.getTotalFreightCharges() != null) {
                        existingOrder.setTotalFreightCharges(order.getTotalFreightCharges());
                    }
                    if (order.getLength() != null) {
                        existingOrder.setLength(order.getLength());
                    }
                    ...
                    if (order.getResellerName() != null) {
                        existingOrder.setResellerName(order.getResellerName());
                    }
                    if (order.getGstin() != null) {
                        existingOrder.setGstin(order.getGstin());
                    }
                    if (order.getCourier() != null) {
                        existingOrder.setCourier(order.getCourier());
                    }
                    if (order.getAwb() != null) {
                        existingOrder.setAwb(order.getAwb());
                    }
                    if (order.getManifestId() != null) {
                        existingOrder.setManifestId(order.getManifestId());
                    }
